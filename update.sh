...
docker run --name raspservice -d --restart unless-stopped --privileged -v /dev/mem:/dev/mem -v /usr/bin/vcgencmd:/usr/bin/vcgencmd -v /usr/lib/aarch64-linux-gnu/libvcos.so.0:/usr/lib/aarch64-linux-gnu/libvcos.so.0 raspservicei
