...
docker run --name raspservice -d --restart unless-stopped --privileged -v /dev/gpiomem:/dev/gpiomem -v /usr/lib/aarch64-linux-gnu/libvcos.so.0:/usr/lib/aarch64-linux-gnu/libvcos.so.0 raspservicei
