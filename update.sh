...
docker run --name raspservice -d --restart unless-stopped --privileged -v /usr/bin/vcgencmd:/usr/bin/vcgencmd -v /dev/mem:/dev/mem -v /usr/lib/aarch64-linux-gnu/libvchiq_arm.so.0:/usr/lib/aarch64-linux-gnu/libvchiq_arm.so.0 raspservicei
